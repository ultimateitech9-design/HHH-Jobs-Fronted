...
const CampusDriveApplicantsPage = lazy(() => import('../modules/campus-connect/pages/CampusDriveApplicantsPage'));
...
const campusConnectRoutes = [
  {
    ...
    children: [
      ...
      { path: 'drives/:driveId/applicants', element: <CampusDriveApplicantsPage /> },
