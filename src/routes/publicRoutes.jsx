...
const ConsultancyLandingPage = lazyPublicRoute(/^\/job-consultant\/?$/, () => import('../modules/consultancy/pages/ConsultancyLandingPage'));
...
const publicRoutes = [
  ...
  { path: 'job-consultant', element: <ConsultancyLandingPage /> },
  { path: 'consultancy', element: <Navigate to="/job-consultant" replace /> },
  { path: 'consultant', element: <Navigate to="/job-consultant" replace /> },
