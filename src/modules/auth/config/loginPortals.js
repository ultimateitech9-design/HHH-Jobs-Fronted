...
const loginPortals = {
  ...
  'campus-connect': {
    ...
    passwordPlaceholder: 'Enter your password',
    allowSocialLogin: false,
    allowedLoginRoles: ['campus_connect'],
    showCreateAccount: false,
    showOtpLogin: true,
